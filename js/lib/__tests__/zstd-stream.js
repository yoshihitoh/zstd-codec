...
const zstd_stream = require('../zstd-stream.js');
const ZstdCompressTransform = zstd_stream.ZstdCompressTransform;
const ZstdDecompressTransform = zstd_stream.ZstdDecompressTransform;
